...
const SOCIAL_ICONS: Record<string, React.ReactNode> = {
  ...
  linkedin: <LinkedinIcon className="text-primary" size={22} />,
  github: <GithubIcon className="text-primary" size={22} />,
};
      ...
      <div className="grid md:grid-cols-2 gap-16 items-start">
        <FadeIn direction="left">
          <div>
            ...
            <p className="mb-12 max-w-lg text-sm leading-relaxed text-on-surface-variant">
          ...
          <div className="bg-surface-container-low p-8 md:p-12 rounded-2xl border border-outline-variant/10">
            <form action={formAction} className="space-y-6">
              ...
              <div className="hidden" aria-hidden="true">
                <label htmlFor="company">{t.contact.hiddenField}</label>
                <input
                  id="company"
                  name="company"
                  type="text"
